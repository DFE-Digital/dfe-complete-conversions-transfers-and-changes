...
RSpec.describe DateHistory::Reasons::EarlierController do
  ...
  describe "#create" do
    context "when the project is a conversion" do
      ...
      it "renders the conversion confirmation view when valid" do
        post project_date_history_reasons_earlier_path(project), params: {
          project: project,
          date_history_reasons_new_earlier_form: {
    ...
    context "when the project is a transfer" do
      ...
      it "renders the new action when the form is invalid" do
        post project_date_history_reasons_earlier_path(project), params: {project: project, date_history_reasons_new_earlier_form: {revised_date: project.transfer_date - 1.month}}
