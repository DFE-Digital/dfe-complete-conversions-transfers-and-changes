  ...
  describe "#create" do
    ...
    context "when the project is valid" do
      ...
      it "assigns the regional delivery officer, calls the TaskListCreator, and redirects to the project path" do
        ...
        expect(task_list_creator).to have_received(:call).with(new_project_record, workflow_root: Conversion::Involuntary::Details::WORKFLOW_PATH)
    ...
    context "when the creating user is not a regional delivery officer" do
      ...
      before do
        ...
        allow_any_instance_of(Conversion::Involuntary::ProjectsController).to receive(:user_id).and_return(caseworker.id)
      end
