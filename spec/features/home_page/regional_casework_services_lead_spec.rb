...
RSpec.feature "The home page for a team lead" do
  ...
  scenario "contains the unassigned projects" do
    ...
    expect(page.current_path).to eql unassigned_regional_casework_services_projects_path
  end
  ...
  scenario "contains the regional casework services in-progress projects" do
    ...
    expect(page.current_path).to eql in_progress_regional_casework_services_projects_path
  end
  ...
  scenario "contains the regional casework services completed projects" do
    ...
    expect(page.current_path).to eql completed_regional_casework_services_projects_path
  end
end
