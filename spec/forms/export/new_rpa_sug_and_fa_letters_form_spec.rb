...
RSpec.describe Export::NewRpaSugAndFaLettersForm, type: :model do
  ...
  describe "#export" do
    ...
    describe "includes the right projects" do
      ...
      let!(:inactive_project) { create(:conversion_project, :inactive, conversion_date: Date.new(2024, 2, 1), urn: 555555) }
