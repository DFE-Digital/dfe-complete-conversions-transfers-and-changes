...
ActiveRecord::Schema[7.0].define(version: 2022_12_06_215007) do
  ...
  create_table "conversion_details", id: :uuid, default: -> { "newid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "action_one_for_task_one_in_section_one"
    t.text "detail_one_for_task_one_in_section_two"
    t.text "land_issues_trust_modification"
  end
