class Conversions::AcademyUrnController < ApplicationController
  ...
  def update_academy_urn
    ...
    redirect_to without_academy_urn_service_support_projects_path, notice: I18n.t("project.academy_urn.confirm.success", academy_urn: academy_urn, urn: @project.urn, school_name: @project.establishment.name)
  end
