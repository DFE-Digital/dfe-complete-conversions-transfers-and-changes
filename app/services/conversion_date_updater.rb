class ConversionDateUpdater
  ...
  def update!
    ActiveRecord::Base.transaction do
      ...
      date_history = SignificantDateHistory.create!(project_id: @project.id, previous_date: @previous_date, revised_date: @revised_date, note: conversion_date_history_note)
