class Project < ApplicationRecord
  ...
  validates :provisional_completion_date, presence: true
  validates :provisional_completion_date, date_in_the_future: true
  validates :provisional_completion_date, first_day_of_month: true
  ...
  scope :by_provisional_completion_date, -> { order(provisional_completion_date: :asc) }
